...
setwd("C:/Users/Usuario/Documents/Master bioinf/Primer cuatrimestre/Algoritmos e inteligencia artificial/Actividades/Actividad grupal")
...
library(ggplot2)
library(caret)
library(cluster) #para los distintos modelos de clusterización
library(factoextra) #para clusterización k-means
library(stats) # también para clusterización k-means
library(ggdendro) # para el modelo de clusterización jerárquico aglomerativo
